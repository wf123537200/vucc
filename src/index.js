...
var vTableColumns = require('./components/table-columns');
// message 的包装代码
window.MessageBox = require('./components/message-box/wrap.js');

/* 为不支持模块化的系统提供简单支持 */
window.__vc_design__ = {vTableColumns, vDatepicker, vMultiSelect, vSearch, vFormItem, vForm, vTransfer, vTree, vTagList, vTimeLine, vToolTip, vSteps, vLoading, vProgress, vStepInput, vPagination, vPane, vCollapseGroup, vCollapse, vInput, vTextarea, vBadge, vAlert, vTableEdit, vSlider, vTable, vButton, vButtonGroup, vSwitch, vCheckbox, vRadio, vDropdown, vSelect, vTips, vDialog, vMask, vMessageBox, vTabs, vButtonGroup};
